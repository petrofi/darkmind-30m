...
from eval_model import DEFAULT_EVAL_PATH, DEFAULT_OUTPUT_DIR, resolve_path, run_evaluation
...
def print_next_steps(candidate_file: Path) -> None:
    ...
    print("=" * 70)
    print("1. Review pending candidate file:")
    ...
    print()
    print("4. Train tokenizer:")
    print("   python scripts/train_tokenizer.py --data_path data/processed/corpus_v3.txt")
    print()
    print("5. Train model:")
    print(
    ...
    print("=" * 70)
    print("This script did not approve candidates, rebuild corpus, or train the model.")


def main() -> None:
    parser = argparse.ArgumentParser(
        description="Run eval and generate pending-review correction candidates."
    )
    parser.add_argument(
        "--checkpoint",
        type=str,
